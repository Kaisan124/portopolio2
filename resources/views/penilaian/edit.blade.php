...
<div class="form-wrapper">
    ...
    <div class="mb-3">
        <a href="{{ route('penilaian.index') }}" class="btn btn-secondary">&larr; Kembali ke Daftar Tugas</a>
    </div>
    ...
    <form action="{{ route('penilaian.update', $data->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="mb-3">
            ...
            <input type="text" name="materi" id="materi" class="form-control" value="{{ old('materi', $data->materi) }}" required>
        </div>

        <div class="mb-3">
            <label for="kelas" class="form-label">Nomor HP</label>
            <input type="text" name="kelas" id="kelas" class="form-control" value="{{ old('kelas', $data->kelas) }}" required>
        </div>
        ...
        <div class="mb-3">
         ...
         <div class="mb-3">
            ...
            <input type="date" name="jadwal" id="jadwal" class="form-control" value="{{ old('jadwal', $data->jadwal) }}" required>
        </div>
